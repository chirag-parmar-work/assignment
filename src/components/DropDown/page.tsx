...
}> = ({ open, button, status, title, description, content, footer }) => {
  return (
...
const DefaultIcon = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M10.8001 14.4033L16.3153 8.88745L17.1643 9.73585L10.8001 16.1001L6.98169 12.2817L7.83009 11.4333L10.8001 14.4033Z"
        fill="#2F64EE"
        fillOpacity="0.29"
      />
    </svg>
